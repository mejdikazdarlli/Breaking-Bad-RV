...
export class MKviewer {
   ...
   async initScene() {
        ...
        this.camera.position.set(110,25,-150)
        ...
        await LoadModel('Bad-RV.glb', this.scene,this.renderer);
        await loadEnvironmentHDR(this.renderer, this.scene, 'brown_photostudio.hdr');
